...
tab <- xtable(matrix(final_acc, ncol = 2, byrow = FALSE,
          dimnames = list(c("PCA + random forest (randomForest)", "PCA + random forest (caret)", "tree (rpart)", "random forest (randomForest", "random Forest controlling cross variance (caret))", c("Accuracy")))),
