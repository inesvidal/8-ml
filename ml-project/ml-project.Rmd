...
```{r, init, cache=TRUE, results='hide', echo=FALSE}
library(knitr)
library(caret)
...
```{r, explore, cache=TRUE, echo=FALSE}
summary(train)
dim(train)
# identificar las variables que no tienen varianza (PCA?)


#fit1 <- randomForest(y = classe, x = train)
```
