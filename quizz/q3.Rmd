...
fit$finalModel
fancyRpartPlot(fit$finalModel, main="Screen segmentation tree")
...
fit$finalModel
fancyRpartPlot(fit$finalModel, main="Olive oil procedence segmentation tree")
...
train <- trainSA[c("age", "alcohol", "obesity", "tobacco", "typea", "ldl", "chd")]
test <- testSA[c("age", "alcohol", "obesity", "tobacco", "typea", "ldl", "chd")]
...
missClass(train$chd, predict(fit, train))
missClass(test$chd, predict(fit, test))
```
...
tree <- train(y ~ ., method = "rf", data = vowel.train)
